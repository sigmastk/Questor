            ...
            switch (State)
            {
                ...
                case UnloadLootState.StackItemsCorpAmmo:
                    if (Settings.Instance.AmmoHangar != string.Empty)
                    {
                        ...
                        // Stack everything
                        if (((corpAmmoHangar != null)  && corpAmmoHangar.IsValid) && corpAmmoHangar.IsReady)
                        {
                ...
                case UnloadLootState.StackItemsCorpLoot:
                    if (Settings.Instance.LootHangar != string.Empty)
                    {
                        ...
                        // Stack everything
                        if (((corpLootHangar != null) && corpLootHangar.IsValid) && corpLootHangar.IsReady)
                        {
                ...
                case UnloadLootState.StackItemsLootContainer:
                    if (Settings.Instance.LootContainer != string.Empty)
                    {
                        ...
                        // Stack everything
                        if (((lootContainer != null) && lootContainer.IsValid) && lootContainer.IsReady)
                        {
