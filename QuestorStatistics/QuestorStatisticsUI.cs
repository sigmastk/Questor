    ...
    public partial class QuestorStatisticsUI : Form
    {
        ...
        public object StatsMision()
        {
            ...
            for (int i = 0; i <= Lst1.Items.Count - 1; i++)
            {
                ...
                for (int o = 0; o <= LstMision.Items.Count - 1; o++)
                {
        ...
        {
            string logToView = ofd.FileName;
            string logdirectoryPath = Path.GetDirectoryName(logToView);
            {
                Lst1.View = View.Details;
                Lst1.FullRowSelect = true;
                Lst1.GridLines = true;
