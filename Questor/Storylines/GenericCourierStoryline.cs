...
public class GenericCourier : IStoryline
{
    ...
    public StorylineState Arm(Storyline storyline)
    {
        ...
        if (ships.Window == null)
        {
            ...
            Logging.Log("GenericCourier: Opening ship hangar");
        ...
        if (item != null)
        {
            Logging.Log("GenericCourier: Switching to an industrial");
        ...
        {
            Logging.Log("GenericCourier: No industrial found, going in active ship");
            return StorylineState.GotoAgent;
        }
    }
    ...
    private bool MoveItem(bool pickup)
    {
        ...
        if (hangar.Window == null)
        {
            ...
            Logging.Log("GenericCourier: Opening hangar floor");
        ...
        if (cargo.Window == null)
        {
            ...
            Logging.Log("GenericCourier: Opening cargo");
        ...
        {
            Logging.Log("GenericCourier:  Moving [" + item.TypeName + "][" + item.ItemId + "] to " + (pickup ? "cargo" : "hangar"));
